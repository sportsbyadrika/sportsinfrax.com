...
<div class="filter-bar">
  <form method="GET" class="row g-2 align-items-end">
    ...
    <div class="col-sm-auto">
      ...
      <a href="<?= h(BASE_URL . '/app/members/list') ?>" class="btn btn-outline-secondary btn-sm ms-1">Reset</a>
    </div>
  </form>
</div>
...
<div class="card table-card">
        ...
        <tr data-table-row>
          ...
          <td>
            <div class="d-flex align-items-center gap-2">
              ...
              <?php endif; ?>
              <div>
                <a href="<?= h(BASE_URL . '/app/members/view?id=' . $m['id']) ?>" class="fw-600 small text-decoration-none text-dark">
  ...
  <div class="card-footer d-flex justify-content-between align-items-center">
    ...
    <?= paginate($total, $page, $perPage, BASE_URL . '/app/members/list') ?>
  </div>
  <?php endif; ?>
</div>
