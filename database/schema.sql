...
-- -------------------------------------------------------
-- Table: attendance_sessions  (all institution types)
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- Table: member_attendance  (students + members, session-based)
-- -------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `transport_vehicles` (
  ...
  `insurance_no`     VARCHAR(80)  DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transport_routes` (
  ...
  `helper_name`       VARCHAR(80)  DEFAULT NULL,
  `morning_departure` TIME         DEFAULT NULL,
  `evening_departure` TIME         DEFAULT NULL,
  `is_active`         TINYINT(1)   NOT NULL DEFAULT 1,
  `created_at`        TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at`        TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
